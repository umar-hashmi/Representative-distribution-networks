...
RF1 = PowerModelsDistribution.parse_file("..//RFs_OpenDSS//RF1.dss")
transform_loops!(RF1)
remove_all_bounds!(RF1)
add_feeders_cktbks!(RF1)
RF1["settings"]["base_frequency"] = 50
RF1["settings"]["sbase_default"] = 630000
rm_spanish_transformer!(RF1)
for (l,line) in RF1["line"]
